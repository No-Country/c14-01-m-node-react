export const emailTemplate = {
    passwordRestoreEmail: (first_name, last_name,email, price, title, location, initialDate, endDate, guests, image) => `
                        ...
                        <td class="esd-email-paddings" valign="top">
                                ...
                                <tbody>
                                    <tr>
                                        <td class="esd-stripe esd-synchronizable-module" align="center">
                                            <table class="es-content-body" align="center" cellpadding="0" cellspacing="0" width="600" style="background-color: transparent;" bgcolor="#f9f0f0">
                                                <tbody>
                                                    <tr>
                            ...
                            <table cellpadding="0" cellspacing="0" class="es-content" align="center">
                                <tbody>
                                    <tr>
                                        <td class="esd-stripe" align="center">
                                            <table bgcolor="#f9f0f0" class="es-content-body" align="center" cellpadding="0" cellspacing="0" width="600">
                                                <tbody>
                                                    <tr>
                                                                    ...
                                                                    <tr>
                                                                        <td width="560" class="esd-container-frame" align="center" valign="top">
                                                                            <table cellpadding="0" cellspacing="0" width="100%">
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td align="center" class="esd-block-image es-p10t es-p10b" style="font-size: 0px;"><a target="_blank"><img src="https://fbixscp.stripocdn.email/content/guids/CABINET_54100624d621728c49155116bef5e07d/images/84141618400759579.png" alt style="display: block;" width="100"></a></td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                ...
                                                                                <tbody>
                                                                                    ...
                                                                                    <tr>
                                                                                        <td align="center" class="esd-block-text es-p5t es-p15b es-p40r es-p40l es-m-p0r es-m-p0l">
                                                                                            <p>Dear <strong>${first_name} ${last_name}</strong> ... This email is to confirm your RESERVATION at </p>
                                                                    ...
                                                                    <tr>
                                                                        <td width="560" class="es-m-p0r esd-container-frame" align="center">
                                                                            <table cellpadding="0" cellspacing="0" width="100%" style="border-top: 2px solid #efefef; border-bottom: 2px solid #efefef;">
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td align="center" class="esd-block-image" style="font-size: 0px;"><a target="_blank"><img class="adapt-img" src="${image}" alt style="display: block;" width="260"></a></td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td align="center" class="esd-block-text es-m-txt-r es-p10t es-p20b">
                                                                                            <span style="background-color:#ffcccc;">Total price:</span><strong><span style="background-color:#ffcccc;">  $ ${price}</span></strong></p>
                                                                                        </td>
                                                                                    </tr>
                                                                                </tbody>
                                                                            </table>
                                                                                ...
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td align="center" class="esd-block-text">
                                                                                            <p style="line-height: 150%;"><strong>Details of your reservation 😎</strong></p>
                                                                                        </td>
                                                                                    </tr>
                                                                                </tbody>
                                                                            </table>
                                                                                ...
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td align="left" class="esd-block-text">
                                                                                            <p>Customer: <strong>${email}</strong></p>
                                                                                            <p>Initial date: <strong>${initialDate}</strong></p>
                                                                                    ...
                                                                                    <tr>
                                                                                        <td align="center" class="esd-block-social es-p15t es-p15b" style="font-size:0">
                                                                                            <table cellpadding="0" cellspacing="0" class="es-table-not-adapt es-social">
                                                                                                <tbody>
                                                                                                    <tr>
                                                                                                        <td align="center" valign="top" class="es-p40r"><a target="_blank" href><img title="Facebook" src="https://fbixscp.stripocdn.email/content/assets/img/social-icons/logo-black/facebook-logo-black.png" alt="Fb" width="32"></a></td>
                                                                                                        <td align="center" valign="top" class="es-p40r"><a target="_blank" href><img title="Twitter" src="https://fbixscp.stripocdn.email/content/assets/img/social-icons/logo-black/twitter-logo-black.png" alt="Tw" width="32"></a></td>
                                                                                                        <td align="center" valign="top" class="es-p40r"><a target="_blank" href><img title="Instagram" src="https://fbixscp.stripocdn.email/content/assets/img/social-icons/logo-black/instagram-logo-black.png" alt="Inst" width="32"></a></td>
                                                                                                        <td align="center" valign="top"><a target="_blank" href><img title="Youtube" src="https://fbixscp.stripocdn.email/content/assets/img/social-icons/logo-black/youtube-logo-black.png" alt="Yt" width="32"></a></td>
                                                                                                    </tr>
                                                                                                </tbody>
                                                                                            </table>
                                                                                        </td>
